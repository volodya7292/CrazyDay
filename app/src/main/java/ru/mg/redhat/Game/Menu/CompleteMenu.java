...
public class CompleteMenu {
    ...
    public static void init(String name, int coins, int secrets, boolean death) {
        ...
        level.addBitmapObject("Background", new Point(640, 360), 0, Graphics.processBitmap("Game/" + name + "/background.png", 1280, 720));
