...
public class PauseMenu {
    ...
    public static void init(final Level pausedLevel, final String levelName) {
        ...
        //Buttons
        level.addButtonObject("Continue", Lang.button_more, new Point(640, 300), 0, 60, ru.mg.redhat.Game.Bitmaps.ui_large_button, ru.mg.redhat.Game.Bitmaps.ui_large_button, Fonts.pauseButtonText, new ClickHandler() {
            @Override
            public void onClick() {
                unload();
        ...
        level.addButtonObject("Restart", Lang.button_restart, new Point(640, 420), 0, 60, Bitmaps.ui_large_button, ru.mg.redhat.Game.Bitmaps.ui_large_button, Fonts.pauseButtonText, new ClickHandler() {
            @Override
            public void onClick() {
                unload();
        ...
        level.addButtonObject("Exit", Lang.button_general_menu, new Point(640, 540), 0, 60, Bitmaps.ui_large_button, ru.mg.redhat.Game.Bitmaps.ui_large_button, Fonts.pauseButtonText, new ClickHandler() {
            @Override
            public void onClick() {
