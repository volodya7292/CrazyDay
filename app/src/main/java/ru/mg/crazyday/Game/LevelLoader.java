...
public class LevelLoader extends AsyncTask<Void, Void, Void> {
    ...
    public void unload(boolean startOver) {
        ...
        if (startOver) {
            ...
            config.setInt("X", (int)(level.bitmapObjects.get("game_person").getX() * Graphics.scaleX));
            config.setInt("Y", (int)(level.bitmapObjects.get("game_person").getY() * Graphics.scaleY));
        }
