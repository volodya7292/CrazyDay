...
public class LevelMenu {
    ...
    public static void init() {
        ...
        level.addBitmapObject("Plate", new Point(640, 360), 1, ru.mg.crazyday.Game.Bitmaps.ui_level_complete_plate_2);
        ...
        level.addButtonObject("Prev", Lang.button_prev, new Point(1050, 90), 0, 80, ru.mg.crazyday.Game.Bitmaps.ui_button, ru.mg.crazyday.Game.Bitmaps.ui_button, Fonts.pauseButtonText, new ClickHandler() {
            @Override
            public void onClick() {
                unload();
                MainMenu.init();
